...
public class MazeTester {
    ...
    public void testPathSearch12() {
        try {
            ...
            solver.initialize(maze);
            int expected = 6;
            int answer = solver.pathSearch(3, 0, 4, 3, 2);
    ...
    public void testPathSearch13() {
        try {
            ...
            solver.initialize(maze);
            int expected = 10;
            int answer = solver.pathSearch(3, 0, 4, 3, 1);
            ImprovedMazePrinter.printMaze(maze, 3, 0);
            assertEquals(expected, answer);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testPathSearch14() {
        try {
            ...
            solver.initialize(maze);
            int expected = 42;
            int answer = solver.pathSearch(3, 0, 4, 3, 0);
            ImprovedMazePrinter.printMaze(maze, 3, 0);
            assertEquals(expected, answer);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testPathSearch15() {
        try {
            ...
            solver.initialize(maze);
            int expected = 4;
            int answer = solver.pathSearch(3, 0, 4, 3, 3);
            ImprovedMazePrinter.printMaze(maze, 3, 0);
            assertEquals(expected, answer);
        } catch (Exception e) {
            e.printStackTrace();
